...
import 'package:app_images/src/usescases/remote/auth/log_out.dart' as _i7;
import 'package:app_images/src/usescases/remote/auth/sign_in.dart' as _i8;
...
_i1.GetIt init(
  ...
  gh.lazySingleton<_i7.LogOut>(() => _i7.LogOut(gh<_i6.IAuthRepository>()));
  gh.lazySingleton<_i8.SignIn>(() => _i8.SignIn(gh<_i6.IAuthRepository>()));
  return getIt;
}
